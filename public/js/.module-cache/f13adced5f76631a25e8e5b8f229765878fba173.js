var App = React.createClass({displayName: "App",
    ...
    componentDidMount: function() {
        this.loadPaginatedDataForPage(1);
    },
    render: function() {
        return (
        ...
        return (
            React.createElement("div", {className: "article-list"}, 
                this.props.articles.map(function(article) {
                    return React.createElement(Article, {key: article.id, article: article})
                })
            )
        );
    }
            ...
            React.createElement("nav", {className: "text-center"}, 
                React.createElement("ul", {className: "pagination pagination-sm"}, 
                    ...
                    React.createElement("li", {className: firstItemClass}, 
                        React.createElement("a", {href: firstItemUrl, "aria-label": "Previous", onClick: this.handlePageClick.bind(this, this.props.currentPage-1)}, 
                    ...
                    React.createElement("li", {className: lastItemClass}, 
                        React.createElement("a", {href: lastItemUrl, "aria-label": "Next", onClick: this.handlePageClick.bind(this, this.props.currentPage+1)}, 
                            React.createElement("span", {"aria-hidden": "true"}, "»")
                        )
                    )
